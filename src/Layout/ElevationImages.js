...
const locationMap = (props) => {
  return (
    <>
      <Helmet>
        <title>Sobha City Gurgaon Elevation Images</title>
        <meta
          name='description'
          content='Find here the top elevation images & furnished photos in Sobha city Gurgaon gives you an idea of the strategic location of an apartment.'
        />
        <link rel='canonical' href='/elevation-images.html' />
      </Helmet>
      <Header />
        ...
        <div className='container'>
          <div className='row'>
            <div className='col-md-12'>
              <h1>{`${window.name} Elevation Images`}</h1>
              <div className='flr_plan'>
                <div className='topplan1'></div>
                <div className='row'>
