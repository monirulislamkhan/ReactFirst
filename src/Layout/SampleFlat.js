  ...
  return (
    <>
      <Helmet>
        ...
        <meta name='description' content='Here we have some pictures of Sobha City Gurgaon Sample flats to provide you a perfect idea of 2 & 3 BHK apartments & help you in making a decision.' />
          ...
          <div className="row">
            <div className="col-md-12">
              <div className='slider_area mt-4'>
                ...
                >
                  <SwiperSlide><div className="inner">
                    ...
                    <div className="inner__right">
                      <a href="images/gallery/sa/sa-01.jpg" data-fancybox="gallery" data-caption="Living Room">
                        <img src="images/gallery/sa/sa-01.jpg" className="img-fluid w-100" alt="Living Room" />
                      </a>
                    </div>
                  </div></SwiperSlide>
                  <SwiperSlide><div className="inner">
                    ...
                    <div className="inner__right">
                      <a href="images/gallery/sa/sa-02.jpg" data-fancybox="gallery" data-caption="Living Room">
                        <img src="images/gallery/sa/sa-02.jpg" className="img-fluid w-100" alt="Living Room" />
                      </a>
                    </div>
                  </div></SwiperSlide>
                  <SwiperSlide><div className="inner">
                    ...
                    <div className="inner__right">
                      <a href="images/gallery/sa/sa-03.jpg" data-fancybox="gallery" data-caption="Living Room">
                        <img src="images/gallery/sa/sa-03.jpg" className="img-fluid w-100" alt="Living Room" />
                      </a>
                    </div>
                  </div></SwiperSlide>
                  <SwiperSlide><div className="inner">
                    ...
                    <div className="inner__right">
                      <a href="images/gallery/sa/sa-04.jpg" data-fancybox="gallery" data-caption="Living Room">
                        <img src="images/gallery/sa/sa-04.jpg" className="img-fluid w-100" alt="Living Room" />
                      </a>
                    </div>
                  </div></SwiperSlide>
                  <SwiperSlide><div className="inner">
                    ...
                    <div className="inner__right">
                      <a href="images/gallery/sa/sa-05.jpg" data-fancybox="gallery" data-caption="Dining Area">
                        <img src="images/gallery/sa/sa-05.jpg" className="img-fluid w-100" alt="Dining Area" />
                      </a>
                    </div>
                  </div></SwiperSlide>
                  <SwiperSlide><div className="inner">
                    ...
                    <div className="inner__right">
                      <a href="images/gallery/sa/sa-06.jpg" data-fancybox="gallery" data-caption="Dining Area">
                        <img src="images/gallery/sa/sa-06.jpg" className="img-fluid w-100" alt="Dining Area" />
                      </a>
                    </div>
                  </div></SwiperSlide>
                  <SwiperSlide><div className="inner">
                    ...
                    <div className="inner__right">
                      <a href="images/gallery/sa/sa-07.jpg" data-fancybox="gallery" data-caption="Bedrooms">
                        <img src="images/gallery/sa/sa-07.jpg" className="img-fluid w-100" alt="Bedrooms" />
                      </a>
                    </div>
                  </div></SwiperSlide>
                  <SwiperSlide><div className="inner">
                    ...
                    <div className="inner__right">
                      <a href="images/gallery/sa/sa-08.jpg" data-fancybox="gallery" data-caption="Bedrooms">
                        <img src="images/gallery/sa/sa-08.jpg" className="img-fluid w-100" alt="Bedrooms" />
                      </a>
                    </div>
                  </div></SwiperSlide>
                  <SwiperSlide><div className="inner">
                    ...
                    <div className="inner__right">
                      <a href="images/gallery/sa/sa-09.jpg" data-fancybox="gallery" data-caption="Master Bedroom">
                        <img src="images/gallery/sa/sa-09.jpg" className="img-fluid w-100" alt="Master Bedroom" />
                      </a>
                    </div>
                  </div></SwiperSlide>
                  <SwiperSlide><div className="inner">
                    ...
                    <div className="inner__right">
                      <a href="images/gallery/sa/sa-10.jpg" data-fancybox="gallery" data-caption="">
                        <img src="images/gallery/sa/sa-10.jpg" className="img-fluid w-100" alt="" />
                      </a>
                    </div>
                  </div></SwiperSlide>
          ...
          <div className="row">
            <div className="col-lg-12 mt-4">
              <div className="gall_des">
                ...
                <p className="">Here are some actual images of the Sobha City Gurgaon Sample Flat to give you a complete idea of 2 and 3 bedroom apartments. So check these images and read the description carefully to make up your mind.</p>
              </div>
            </div>
          </div>
        </div>
