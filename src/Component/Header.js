      ...
      <div className='container-fluid'>
        ...
        <div className='collapse navbar-collapse' id='navbarSupportedContent'>
          <ul className='navbar-nav ms-auto mb-2 mb-lg-0'>
            ...
            <li
              className={`nav-item ${
                props.location.pathname === '/specifications.html'
                  ? 'active'
                  : ''
              }`}
            >
            ...
            <li
              className={`nav-item ${
                props.location.pathname === '/price-list.html' ? 'active' : ''
              }`}
            >
            ...
            <li
              className={`nav-item ${
                props.location.pathname === '/location-map.html' ? 'active' : ''
              }`}
            >
            ...
            <li
              className={`nav-item ${
                props.location.pathname === '/master-plan.html' ? 'active' : ''
              }`}
            >
            ...
            <li
              className={`nav-item ${
                props.location.pathname === '/floor-plan.html' ? 'active' : ''
              }`}
            >
            ...
            <li
              className={`nav-item dropdown ${
                props.location.pathname === '/elevation-images.html'
                  ? 'active'
                  : ''
              } : ${
            ...
            >
              ...
              >
                ...
                <li className={`nav-item`}>
                  <Link
                    className={`dropdown-item ${
                      props.location.pathname === '/sample-flat.html'
                        ? 'active'
                        : ''
                    }`}
                    to='/sample-flat.html'
